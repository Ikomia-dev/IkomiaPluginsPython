...
# --------------------
class ColorfulImageColorizationProcessParam(PyCore.CProtocolTaskParam):
...
# --------------------
class ColorfulImageColorizationProcess(PyDataProcess.CImageProcess2d):
...
# --------------------
class ColorfulImageColorizationProcessFactory(PyDataProcess.CProcessFactory):
