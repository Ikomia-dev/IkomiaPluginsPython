...
# --------------------
class scikit_thresholdParam(PyCore.CProtocolTaskParam):
...
# --------------------
class scikit_thresholdProcess(PyDataProcess.CImageProcess2d):
...
# --------------------
class scikit_thresholdProcessFactory(PyDataProcess.CProcessFactory):
