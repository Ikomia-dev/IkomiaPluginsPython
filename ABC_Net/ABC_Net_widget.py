...
import QtConversion
import ABC_Net_process as processMod
...
# --------------------
class ABC_NetWidget(PyCore.CProtocolTaskWidget):

    def __init__(self, param, parent):
        PyCore.CProtocolTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = processMod.ABC_NetParam()
        else:
...
#--------------------
class ABC_NetWidgetFactory(PyDataProcess.CWidgetFactory):
    ...
    def create(self, param):
        ...
        return ABC_NetWidget(param, None)
