...
#- Inherits PyCore.CProtocolTaskWidget from Imageez API
#--------------------
class NeuralStyleTransferWidget(PyCore.CProtocolTaskWidget):
...
#- Inherits PyDataProcess.CWidgetFactory from Imageez API
#--------------------
class NeuralStyleTransferWidgetFactory(PyDataProcess.CWidgetFactory):
