...
# --------------------
class ResNetActionRecognitionParam(PyCore.CProtocolTaskParam):
...
# --------------------
class ResNetActionRecognitionProcess(PyDataProcess.CVideoProcess):

    def __init__(self, name, param):
        PyDataProcess.CVideoProcess.__init__(self, name)
        self.net = None
        self.last_label = ""
        self.class_names = []
        self.frames = None
...
# --------------------
class ResNetActionRecognitionProcessFactory(PyDataProcess.CProcessFactory):
