...
# --------------------
class Detectron2_MaskRCNNParam(PyCore.CProtocolTaskParam):
...
# --------------------
class Detectron2_MaskRCNNProcess(PyDataProcess.CImageProcess2d):
...
# --------------------
class Detectron2_MaskRCNNProcessFactory(PyDataProcess.CProcessFactory):
