...
import numpy as np
from PyCore import CImageProcessIO
import cv2
...
# --------------------
class scikit_MorphoSnakesParam(PyCore.CProtocolTaskParam):
...
# --------------------
class scikit_MorphoSnakesProcess(PyDataProcess.CImageProcess2d):
    ...
    def __init__(self, name, param):
        ...
        self.addInput(CImageProcessIO())

         # add output -> results image
        self.addOutput(CImageProcessIO())
...
# --------------------
class scikit_MorphoSnakesProcessFactory(PyDataProcess.CProcessFactory):
